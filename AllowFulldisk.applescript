...
set nameOfRowToSelect to "Full Disk Access"
set appCheckboxToClick to "ESET Cyber Security Pro"
...
tell application "System Events" to tell application process "System Preferences"
    ...
    tell window "Security & Privacy"
        ...
        --- Allow access - Begin
        click checkbox 1 of UI element 1 of (first row of table 1 of scroll area 1 of group 1 of tab group 1 whose (value of static text of item 1 of UI element 1) contains appCheckboxToClick)
