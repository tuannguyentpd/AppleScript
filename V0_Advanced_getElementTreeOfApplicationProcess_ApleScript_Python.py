...
class UIElementsTree:
    def __init__(self, application="System Events", process="System Preferences"):
        ...
        self.__apllescript_object_types = ["application processes", "application process", "window", "anchor", "scroll area", "tab group", "splitter group", "static text", "sheet", "table", "checkbox", "button", "text field", "group", "scroll bar", "toolbar", "image", "menu bar", "menu item", "menu", "application", "list"]
    ...
    def generateEventScript(self, event='click', objStr=None, parrentSig=None):
    ...
    def sendEvent(self, event='click', objStr=None):
        res = False

        cmd = self.generateEventScript(event, objStr)
        if cmd == None:
            return False
...
if __name__ == '__main__':
    uiTree = UIElementsTree(process='esets_gui')#System Preferences, ESET Cyber Security Pro/esets_gui
    ...
    print(uiTree.sendEvent('click', 'button Smart scan'))
